...
\icesimp~Powder Snow (6) &\ghostsimp~Shadow Claw (9)&\steelsimp~Bullet Punch (9) \\
...
\textbf{Rayquaza} \hfill \dragonfull~\flyingfull & \textbf{Mewtwo} \hfill \psychicfull & \textbf{Roserade}\hfill \grassfull~\poisonfull  & \textbf{Gardevoir} \hfill \psychicfull~\fairyfull  \\ 
\multicolumn{1}{c}{\includegraphics[width=2cm]{../../images/pokemon/Rayquaza}} & \multicolumn{1}{c}{\includegraphics[width=2cm]{../../images/pokemon/Mewtwo}} & \multicolumn{1}{c}{\includegraphics[width=2cm]{../../images/pokemon/Roserade}} & \multicolumn{1}{c}{\includegraphics[width=2cm]{../../images/pokemon/Gardevoir}} \\   \hline
\dragonsimp~Dragon Tail (15) & \psysimp~Psycho Cut (5) & \grasssimp~Razor Leaf (13) & \fairysimp~Charm (20) \\
\dragonsimp~Outrage (110) & \ghostsimp~Shadow Ball (100) &  \grasssimp~Grass Knot (90) & \fairysimp~Dazzling Gleam \\
\flyingsimp~Aeral Ace (55) & \fightingsimp~Focus Blast (150) &  \poisonsimp~Sludge Bomb (80) & \\ 
\end{tabular}
\end{center}
...
Ideal moveset &  \fairysimp~Charm (20) & \watersimp~Bubble (12)& \bugsimp~Infestation (10) & \flyingsimp~Air Slash (14) & \fairysimp~Charm (20) \\
