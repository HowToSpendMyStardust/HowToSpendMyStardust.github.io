...
\begin{tabular}{p{4cm}rp{4cm}rp{5cm}} 
\textbf{Machamp} \hfill  \fightingfull \\
\multicolumn{1}{c}{\multirow{6}{*}{\includegraphics[width=3cm]{../../images/pokemon/machamp.png}}} & Base ATK &  \attack{234} &   DPS &   \dps{16.21} \\ 
&Base DEF & \defense{159}&  Health &\survival{26.81}   \\
&Base HP & \stamina{207} &     TDO &\tdo{434.6} \\ %\cline{2-3}
&\multirow{2}{*}{Moveset}   & \fightingsimp~Counter (12)  & Remarks & \multirow{3}{5cm}{Machamp is the best \fightingfull~ Pok\'emon until gen 5 \\} \\
