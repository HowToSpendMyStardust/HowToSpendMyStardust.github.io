...
\usepackage[orientation=portrait,size=custom,width=15,height=18,scale=0.5,debug]{beamerposter} 
...
& Moves & #1                 & Remarks & \multirow{3}{4cm}{#4} \\
&  		   & #2 & \\
&Weak to    & #3 &   \\
}
...
\end{itemize}
\item \textbf{Generation 5 competitor}: \textbf{Conkeldurr} (higher DPS\&TDO than Machamp)
\end{itemize}
\end{center}
\end{block}
...
\begin{itemize}
\item \textbf{Generation 5 competitor}: \textbf{Chandelure} (more DPS\&TDO than Gengar, no \psychicfull~weakness, but still fragile)
\end{itemize}
\end{center}
\end{block}
