...
\usepackage[orientation=portrait,size=custom,width=15,height=20,scale=0.5,debug]{beamerposter} 
...
\draw [line width=7.pt,color=#1] (0.,0.)-- (#2/130,0.);
...
\newcommand*{\dps}[1]{
\begin{tikzpicture}[line cap=round,line join=round,>=triangle 45,x=1.0cm,y=1.0cm]\clip(-0.15,-0.1) rectangle (2.5,0.1);
\draw [line width=6.pt,color=black] (0.,0.)-- (#1/8.7,0.);
\draw[color=white] (0.3,0.) node {\scriptsize{$#1$}};
\end{tikzpicture}
}
\newcommand*{\survival}[1]{
\begin{tikzpicture}[line cap=round,line join=round,>=triangle 45,x=1.0cm,y=1.0cm]\clip(-0.15,-0.1) rectangle (2.5,0.1);
\draw [line width=6.pt,color=black] (0.,0.)-- (#1/18.,0.);
\draw[color=white] (0.3,0.) node {\scriptsize{$#1$}};
\end{tikzpicture}
}
\newcommand*{\tdo}[1]{
\begin{tikzpicture}[line cap=round,line join=round,>=triangle 45,x=1.0cm,y=1.0cm]\clip(-0.15,-0.1) rectangle (2.5,0.1);
\draw [line width=6.pt,color=black] (0.,0.)-- (#1/282.,0.);
\draw[color=white] (0.3,0.) node {\scriptsize{$#1$}};
\end{tikzpicture}
}
...
\newcommand*{\pokemon}[6]{
\begin{tabular}{p{2.5cm}rp{3cm}rp{4cm}} 
\textbf{#1}~#2 \hfill  #3 \\
...
\begin{itemize}
  \item \scriptsize \textbf{Breloom} (more DPS than Machamp, but very low Health),
  \item \scriptsize  \textbf{Mewtwo} (with Focus Blast, DPS: 13.64, good Health, and not weak to \psychicfull~moves)
\end{itemize}
\item \textbf{Generation 5 competitor}: 
\begin{itemize}
  \item \scriptsize \textbf{Conkeldurr} (higher DPS\&TDO than Machamp)
\end{itemize}
\end{itemize}
\end{center}
\end{block}
...
\item \textbf{Generation 5 competitor}: 
\begin{itemize}
  \item \scriptsize \textbf{Chandelure} (more DPS\&TDO than Gengar, no \psychicfull~weakness, but still fragile)
\end{itemize}
\end{itemize}
\end{center}
\end{block}
...
\begin{itemize}
  ...
  \begin{itemize}
  \item \scriptsize\textbf{Hydreigon} (similar to Tyranitar)
  \item \scriptsize\textbf{Zoroark} (as fragile as Weawile)
\end{itemize}
\end{itemize}
\end{center}
\end{block}
...
\pokemon{Dragonite}{}{\dragonfull~\flyingfull}{dragonite.png}{{263}{198}{209}{17.23}{33.11}{570.5}}{{\dragonsimp~Dragon Tail (15)}{\dragonsimp~Outrage (110)}{\fightingfull~\groundfull}{Worse Rayquaza. \\ }}


\pokemon{Dialga}{}{\steelfull~\dragonfull}{Dialga.png}{{275}{211}{205}{17.09}{34.51}{589.7}}{{\dragonsimp~Dragon Breath (6)}{\dragonsimp~Draco Meteor (150)}{\dragonfull~\fairyfull}{No \dragonfull~ weakness. \\ }}
