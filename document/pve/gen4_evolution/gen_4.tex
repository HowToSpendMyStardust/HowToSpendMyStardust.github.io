...
\textbf{Supreme counters}

\begin{center}
\begin{tabular}{p{1.9cm}p{1.9cm}p{1.9cm}p{1.9cm}p{1.9cm}p{1.9cm}}
\textbf{Mamoswine} & \textbf{Magnezone} & \textbf{Rhyperior} & \textbf{Roserade} & \textbf{Weavile} & \textbf{Togekiss} \\
\includegraphics[height=1.8cm]{../../images/pokemon/mamoswine}  & \includegraphics[height=1.8cm]{../../images/pokemon/magnezone} & \includegraphics[height=1.8cm]{../../images/pokemon/rhyperior} & \includegraphics[height=1.8cm]{../../images/pokemon/roserade} & \includegraphics[height=1.8cm]{../../images/pokemon/weavile} & \includegraphics[height=1.8cm]{../../images/pokemon/togekiss} \\ 
100 \candy~+\sinnohstone   & 100 \candy~+\magneticlure   & 100 \candy~+\sinnohstone   & 100 \candy~+\sinnohstone   & 100 \candy~+\sinnohstone & 100 \candy~+\sinnohstone   \\ 
Evolves from Pilowsine & Evolves from Magneton & Evolves from Rhydon &Evolves from Roselia& Evolves from Sneasel & Evolves from Togetic \\ 
$\oplus$ Best \icefull~Pokémon, and good \groundfull~attacker  & $\oplus$ Good \electricfull~Pok\'emon, with a ton of resistance & $\oplus$ A good \rockfull~attacker and good \groundfull~attacker & $\oplus$ Best \grassfull~and \poisonfull~DPS & $\oplus$ Best \darkfull~Pokémon and good \icefull~Pokémon & $\oplus$ Great gym defender, and useful vs Palkia \\
& & $\ominus$ Could get an exclusive move in the future & $\ominus$ A bit fragile & $\ominus$ Tyranitar is bulkier than Weavile & $\ominus$ Could get a \fairyfull~fast move in the future \\
\end{tabular}
\end{center}

\textbf{Relevant counters}
