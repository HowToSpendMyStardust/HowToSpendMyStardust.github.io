...
\begin{tabular}{rp{2cm}} 
  ...
  Base\_HP + IV\_HP & \stamina{229} \\ % \hline
\end{tabular}   
\end{center}
...
HP =  (HP + IV\_HP) at level 30 & \stamina{167} \\ % \hline
\end{tabular}   
\end{center}
...
\begin{block}{}
\begin{tiny}
\textbf{6. How difficult are Raid bosses?}
...
\begin{block}{}
\begin{tiny}
\textbf{7. How are IV important?}

%They depends on the Pok\'emon base statistics. 
\begin{itemize}
  \item If the Pok\'emon has an important base attack statistic, there will be no difference between IV\_ATT = 14 and IV\_ATT = 15. 
  
  It is recommended to that a high IV\_ATT for Pok\'emon with low DPS.
  \item Regarding to bulkiness (IV\_DEF and IV\_HP), the defence statistic influences how fast your Pok\'emon will die, whereas the HP statistic tells you the total number of HP your Pok\'emon will have. Usually, it is more interesting to have a higher IV\_DEF than IV\_HP. 
  
  It is recommended to that a high IV\_DEF and IV\_HP for Pok\'emon with low Effective Health.
\end{itemize}

It is also recommended to level up at least to level 30 your Pok\'emon. At level 30, your Pokemon is already at 92.6\% of its capacity!

\medskip

\textbf{8. What is the optimal level for a Pok\'emon?}
\begin{center}
...
The more you want to level up your Pok\'emon, the more expansive it will be. Level 35 is fine (where your Pok\'emon is at 96.4\% of its capacity), but level 30 is good too (92.6\% of its capacity). There is an ideal level depending on each Pok\'emon and its opponent: 
\begin{itemize}
