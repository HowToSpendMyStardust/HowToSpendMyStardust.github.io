...
\newcommand{\candy}{\includegraphics[height=0.15cm]{../../images/objects/rare_candy}}
...
\begin{footnotesize}
\begin{itemize}
  \item Three statistics define a Pok\'emon: the attack statistic defines the damage your Pokémon will do, the defence statistic defines the speed at which your Pokémon will die, the HP is your Pokémon's Hit Points.
...
\end{center}
  ...
  \item Depending on the level of your Pokémon, you will multiply all these stats by a coefficient:
...
This table says that at level 25, your Pokemon is at 84.5\% of its capacity; at level 30, your Pokemon is at 92.6\% of its capacity; at level 35, your Pokemon is at 96.4\% of its capacity. Coming back to your perfect Mewtwo, if you level up it to level 40, its statistics are finally:
\begin{center}
\begin{tabular}{rp{3cm}} 
...
Your friend caught a Mewtwo with (ATK\_IV, DEF\_IV, HP\_IV) = (14, 15, 14). If we do the same calculations as previous, its Mewtwo, at level 40, will have the following statistics:
\begin{center}
\begin{tabular}{rp{3cm}} 
ATK at level 40  &  \attack{248} \\
DEF at level 40 & \defense{155} \\
...
Surprisingly, Mewtwo (14, 15, 14) at level 40 and (15, 15, 15) at level 40 both have exactly the same statistics! 
