...
\begin{itemize}
  \item If the Pok\'emon has an important base attack statistic, there will be no difference between ATT\_IV = 14 and ATT\_IV = 15. 
  
  It is recommended to that a high ATT\_IV for Pok\'emon with low DPS.
