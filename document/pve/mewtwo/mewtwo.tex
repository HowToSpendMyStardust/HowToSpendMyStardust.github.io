...
\textbf{For raids}:
\begin{itemize}
  \item \ghostfull~ Giratina is better and has more life than Mewtwo. However, Giratina has two weaknesses \icefull~\fairyfull~than Mewtwo doesn't have.
  \item \psychicfull~ Mewtwo is the best \psychicfull~Pokémon, although this has no utility until gen 5.
  \item \fightingfull~ Machamp is better than Mewtwo. Although Mewtwo is not weak to \psychicfull, making it usefull versus bosses having \psychicfull~moves (Arceus, Regigigas).
...
\textbf{For gyms}:
\begin{itemize}
  \item \fightingfull~ Mewtwo can counter Blissey, Snorlax, Chansey, Rhyperior and all \normalfull~\rockfull~Pok\'emon.
  \item \ghostfull~ Mewtwo can counter Espeon, Gardevoir, Metagross.
  \item \icefull~ Mewtwo can counter Dragonite, Salamence, Togekiss.
\end{itemize}
