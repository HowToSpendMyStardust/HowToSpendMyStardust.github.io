...
\usebackgroundtemplate{\includegraphics[width=\paperwidth]{../../images/type/background/lucky}}
\begin{frame}
...
& \includegraphics[width=1cm]{../../images/pokemon/moltres.png}
...
\begin{center}
\begin{tabular}{ccccc}
\includegraphics[width=1cm]{../../images/pokemon/shiny/salamence_shiny.png}
& \includegraphics[width=1cm]{../../images/pokemon/shiny/metagross_shiny.png}
& \includegraphics[width=1cm]{../../images/pokemon/shiny/tyranitar_shiny.png} 
& \includegraphics[width=1cm]{../../images/pokemon/shiny/roserade_shiny.png}
& \includegraphics[width=1cm]{../../images/pokemon/shiny/meltan_shiny.png}\\
Outrage & Meteor Mash &  & \\
\end{tabular}
\end{center}
...
\begin{center}
\begin{tabular}{ccc}
\includegraphics[width=1cm]{../../images/pokemon/shiny/gibble.png}
& \includegraphics[width=1cm]{../../images/pokemon/shiny/riolu.png}
& \includegraphics[width=1cm]{../../images/pokemon/shiny/kranidos.png} \\
\end{tabular}
\end{center}
\end{itemize}
