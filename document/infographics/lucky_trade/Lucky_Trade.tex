...
& \includegraphics[width=1.5cm]{../../images/pokemon/shiny/roserade_shiny.png}
...
\begin{center}
\begin{tabular}{ccc}
\includegraphics[width=1.5cm]{../../images/pokemon/shiny/gibble.png}
& \includegraphics[width=1.5cm]{../../images/pokemon/shiny/riolu.png}
& \includegraphics[width=1.5cm]{../../images/pokemon/shiny/kranidos.png} \\
\end{tabular}
\end{center}
\end{itemize}
