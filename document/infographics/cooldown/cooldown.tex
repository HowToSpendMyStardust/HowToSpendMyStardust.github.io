...
\begin{frame}
\frametitle{Daily task checklist}

\begin{block}{}

\begin{todolist}
\item Catch a Pokémon
\item Spin a Pokéstop/Gym
\item Validate a quest
\item Earn 50 coins
\item Win a raid with your free pass (or skip it and win it tomorrow without any new skips/postponements only if you received the pass today, don’t forget to receive a new free pass after player the next day’s raid)
\item Do a special trade with a friend 
\item Send/Open your gifts to/from your friends
\item Do PVPs, 3 with friends, 1 with NPC gym leader
\item Find Smeargle
\end{todolist}
