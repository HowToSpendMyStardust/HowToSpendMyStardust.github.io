...
\begin{frame}
\frametitle{Ideal bag}

\begin{block}{}

\begin{center}
\begin{tabular}{ccc}
\includegraphics[width=0.5cm]{../../images/objects/max_potion} & Max potion & 200 \\
\includegraphics[width=0.5cm]{../../images/objects/revive}  & Revive & 200 \\
\includegraphics[width=0.5cm]{../../images/objects/max_revive}  & Max Revive& 300 \\
\includegraphics[width=0.5cm]{../../images/objects/lucky_egg} & Lucky Egg& 30 \\
\includegraphics[width=0.5cm]{../../images/objects/incense}  & Incense& 20 \\
\includegraphics[width=0.5cm]{../../images/objects/lure} & Lure module & 10 \\
\includegraphics[width=0.5cm]{../../images/objects/fast_tm} & Fast TM & 50 \\
\includegraphics[width=0.5cm]{../../images/objects/charged_tm} & Charged TM & 100 \\
\includegraphics[width=0.5cm]{../../images/objects/rare_candy} & Rare candy & 200 \\
\includegraphics[width=0.5cm]{../../images/objects/raid_pass} & Raid Pass & $-$ \\
\includegraphics[width=0.5cm]{../../images/objects/starpiece} & Star Piece & 50 \\
\includegraphics[width=0.5cm]{../../images/objects/gift} & Gift & 10 \\
\includegraphics[width=0.5cm]{../../images/objects/pokeball} & Pokeball & 200 \\
\includegraphics[width=0.5cm]{../../images/objects/ultraball}  & Ultra ball & 200 \\
\includegraphics[width=0.5cm]{../../images/objects/pinap_berry}  & Pinap berry & 100 \\
\includegraphics[width=0.5cm]{../../images/objects/golden_razzberry} & Golden razzberry& 150 \\
\includegraphics[width=0.5cm]{../../images/objects/silver_pinapberry}  & Silver Pinap berry & 100 \\
\includegraphics[width=0.5cm]{../../images/objects/sinnoh_stone} & Sinnoh stone & 50 \\
\end{tabular} 
\end{center}
