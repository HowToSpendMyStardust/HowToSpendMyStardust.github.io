...
\newcommand{\magneticlure}{\includegraphics[height=0.2cm]{../../images/objects/magnetic_lure}}
\newcommand{\glaciallure}{\includegraphics[height=0.2cm]{../../images/objects/glacial_lure}}
\newcommand{\sinnohstone}{\includegraphics[height=0.2cm]{../../images/objects/sinnoh_stone}}
...
\begin{frame}
\frametitle{Generation 4 Evolutions}
...
\begin{center}
\textbf{\small Supreme counters}

\bigskip

\begin{tabular}{p{4cm}p{4cm}p{4cm}}
\textbf{Mamoswine} & \textbf{Magnezone} & \textbf{Rhyperior} \\
\includegraphics[height=1.8cm]{../../images/pokemon/mamoswine}  & \includegraphics[height=1.8cm]{../../images/pokemon/magnezone} & \includegraphics[height=1.8cm]{../../images/pokemon/rhyperior}  \\ 
100 \candy~+\sinnohstone   & 100 \candy~+\magneticlure   & 100 \candy~+\sinnohstone      \\ 
Evolves from Pilowsine & Evolves from Magneton & Evolves from Rhydon  \\ 
$\oplus$ Best \icefull~Pokémon, and good \groundfull~attacker  & $\oplus$ Good \electricfull~Pok\'emon, with a ton of resistance & $\oplus$ A good \rockfull~attacker and good \groundfull~attacker  \\
& & $\ominus$ Could get an exclusive move in the future \\
\end{tabular}

\bigskip

\begin{tabular}{p{4cm}p{4cm}p{4cm}}
\textbf{Roserade} & \textbf{Weavile} & \textbf{Togekiss} \\
 \includegraphics[height=1.8cm]{../../images/pokemon/roserade} & \includegraphics[height=1.8cm]{../../images/pokemon/weavile} & \includegraphics[height=1.8cm]{../../images/pokemon/togekiss} \\ 
 100 \candy~+\sinnohstone   & 100 \candy~+\sinnohstone & 100 \candy~+\sinnohstone   \\ 
Evolves from Roselia& Evolves from Sneasel & Evolves from Togetic \\ 
$\oplus$ Best \grassfull~and \poisonfull~DPS & $\oplus$ Best \darkfull~Pokémon and good \icefull~Pokémon & $\oplus$ Great gym defender, and useful vs Palkia \\
$\ominus$ A bit fragile & $\ominus$ Tyranitar is bulkier than Weavile & $\ominus$ Could get a \fairyfull~fast move in the future \\
\end{tabular}

\bigskip\bigskip\bigskip\bigskip

\textbf{\small Relevant counters}

\bigskip

\begin{tabular}{p{4cm}p{4cm}p{4cm}}
\textbf{Glaceon} & \textbf{Electivire} & \textbf{Honchkrow} \\
\includegraphics[height=1.8cm]{../../images/pokemon/glaceon} & \includegraphics[height=1.8cm]{../../images/pokemon/electivire} & \includegraphics[height=1.8cm]{../../images/pokemon/honchkrow} \\   
25 \candy~+\glaciallure   & 100 \candy~+\sinnohstone  &100 \candy~+\sinnohstone   \\
Evolves from Eevee & Evolves from Electabuzz &Evolves from Murkrow \\
$\oplus$ Good \icefull~Pokémon & $\oplus$ Best \electricfull~DPS  & Best \flyingfull~Pokémon \\
& $\ominus$ Very fragile in raids & $\ominus$ Very fragile \\
\end{tabular}
\end{center}
