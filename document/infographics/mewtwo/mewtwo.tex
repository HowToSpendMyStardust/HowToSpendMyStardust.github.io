...
\usebackgroundtemplate{\includegraphics[height=\paperheight]{background.png}}
\begin{frame}
\begin{footnotesize}
...
\begin{block}{}
Read also: \url{https://pokemongo.gamepress.gg/pokemon/150}
\end{block}
...
\end{tabular}
\end{center}
\caption{\footnotesize Neutral DPS}
\end{table}

\vspace{-0.5cm}
\begin{itemize}
  \item Vs other \ghostfull~type Pokémon, Giratina is better than Mewtwo. \\ However, Giratina has two weaknesses \icefull~\fairyfull~than Mewtwo doesn't have.
  \item Vs other \psychicfull~type Pokémon, Mewtwo remains the best \psychicfull~Pokémon, although Psychic has no utility until gen 5.
  \item Vs other \fightingfull~type Pokémon, Machamp is better than Mewtwo. \\ However, Mewtwo is not weak to \psychicfull, making it usefull versus bosses having \psychicfull~moves (Arceus, Regigigas).
  \item Vs other \icefull~type Pokémon, Mamoswine, Glaceon and Weawile are better than Mewtwo. \\ However, Mewtwo doesn't have \firefull~\grassfull~weakness, which makes it usefull versus Groudon.
  \item Vs other \firefull~type Pokémon, Moltres and Entei are better than Mewtwo.
  \item Vs other \electricfull~type Pokémon, Raikou and Magnezone are better than Mewtwo.
%  \item Vs other \normalfull~type Pokémon, Hyper Beam is not optimal.
\end{itemize}
\end{block}
...
\begin{itemize}
  \item With a \fightingfull~type charged move, Mewtwo can counter Blissey, Snorlax, Chansey, Rhyperior, Tyranitar, Dialga, Melmetal and more generally, all \normalfull~\rockfull~Pok\'emon.
  \item With a \ghostfull~type charged move, Mewtwo can counter Espeon, Gardevoir, Metagross.
  \item With a \icefull~type charged move, Mewtwo can counter Dragonite, Salamence, Garchomp, Togekiss, Groudon.
\end{itemize}
\end{block}
...
\multirow{2}{*}{Ideal moveset for PvE \& PvP}   & \psysimp~Psycho Cut (5) \\
...
\begin{tabular}{p{4cm}p{3cm}} 
%  &  \multicolumn{1}{c}{\includegraphics[width=2cm]{../../images/pokemon/mewtwo.png} } \\ \hline
\multirow{2}{*}{Another ideal moveset for PvP}   & \psysimp~Psycho Cut (5) \\
    & \ghostsimp~Shadow Ball$^{\dag}$(100) \\
    & \icesimp~Ice Beam (90) \\  
%  ATT &  \attack{300} \\
%  DEF & \defense{182} \\
